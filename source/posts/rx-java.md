...
so I thought I'd learn some more. Then I stumbled upon a video from a recent
...
1. Observables are not opnionated about how the backend works.  It could be
  ...
  of handling the code weather or not the backend is synchronus of asynchronus.

1. The methods for manipulating multiple observers, chaining or nesting
  them are extremely powerful, yet easy to understand
